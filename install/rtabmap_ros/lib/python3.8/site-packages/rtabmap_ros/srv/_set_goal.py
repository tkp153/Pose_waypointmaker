...
class Metaclass_SetGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _set_goal
...
class SetGoal(metaclass=Metaclass_SetGoal):
    from rtabmap_ros.srv._set_goal import SetGoal_Request as Request
    from rtabmap_ros.srv._set_goal import SetGoal_Response as Response
