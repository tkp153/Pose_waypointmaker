...
bool rtabmap_ros__srv__get_node_data__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._get_node_data.GetNodeData_Request", full_classname_dest, 50) == 0);
  }
  rtabmap_ros__srv__GetNodeData_Request * ros_message = _ros_message;
  {  // ids
...
PyObject * rtabmap_ros__srv__get_node_data__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._get_node_data");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__get_node_data__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._get_node_data.GetNodeData_Response", full_classname_dest, 51) == 0);
  }
  rtabmap_ros__srv__GetNodeData_Response * ros_message = _ros_message;
  {  // data
    ...
    if (!rtabmap_ros__msg__NodeData__Sequence__init(&(ros_message->data), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create rtabmap_ros__msg__NodeData__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    rtabmap_ros__msg__NodeData * dest = ros_message->data.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!rtabmap_ros__msg__node_data__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * rtabmap_ros__srv__get_node_data__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // data
    ...
    rtabmap_ros__msg__NodeData * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->data.data[i]);
      PyObject * pyitem = rtabmap_ros__msg__node_data__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
