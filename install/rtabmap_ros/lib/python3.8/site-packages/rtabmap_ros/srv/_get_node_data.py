...
class GetNodeData_Response(metaclass=Metaclass_GetNodeData_Response):
    ...
    _fields_and_field_types = {
        'data': 'sequence<rtabmap_ros/NodeData>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'NodeData')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'data' field must be a set or sequence and each value of type 'NodeData'"
        self._data = value
...
class Metaclass_GetNodeData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _get_node_data
...
class GetNodeData(metaclass=Metaclass_GetNodeData):
    from rtabmap_ros.srv._get_node_data import GetNodeData_Request as Request
    from rtabmap_ros.srv._get_node_data import GetNodeData_Response as Response
