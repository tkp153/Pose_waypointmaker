...
bool rtabmap_ros__srv__get_nodes_in_radius__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._get_nodes_in_radius.GetNodesInRadius_Request", full_classname_dest, 61) == 0);
  }
  rtabmap_ros__srv__GetNodesInRadius_Request * ros_message = _ros_message;
  {  // node_id
...
PyObject * rtabmap_ros__srv__get_nodes_in_radius__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._get_nodes_in_radius");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__get_nodes_in_radius__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._get_nodes_in_radius.GetNodesInRadius_Response", full_classname_dest, 62) == 0);
  }
  rtabmap_ros__srv__GetNodesInRadius_Response * ros_message = _ros_message;
  {  // ids
