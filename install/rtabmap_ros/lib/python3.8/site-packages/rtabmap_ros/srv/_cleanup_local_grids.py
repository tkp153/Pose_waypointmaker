...
class Metaclass_CleanupLocalGrids(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rtabmap_ros.srv.CleanupLocalGrids')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rtabmap_ros.srv import _cleanup_local_grids
...
class CleanupLocalGrids(metaclass=Metaclass_CleanupLocalGrids):
    from rtabmap_ros.srv._cleanup_local_grids import CleanupLocalGrids_Request as Request
    from rtabmap_ros.srv._cleanup_local_grids import CleanupLocalGrids_Response as Response
