...
class Metaclass_GetNodesInRadius(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _get_nodes_in_radius
...
class GetNodesInRadius(metaclass=Metaclass_GetNodesInRadius):
    from rtabmap_ros.srv._get_nodes_in_radius import GetNodesInRadius_Request as Request
    from rtabmap_ros.srv._get_nodes_in_radius import GetNodesInRadius_Response as Response
