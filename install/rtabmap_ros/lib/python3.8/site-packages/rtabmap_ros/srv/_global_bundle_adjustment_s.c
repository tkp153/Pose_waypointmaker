...
bool rtabmap_ros__srv__global_bundle_adjustment__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._global_bundle_adjustment.GlobalBundleAdjustment_Request", full_classname_dest, 72) == 0);
  }
  rtabmap_ros__srv__GlobalBundleAdjustment_Request * ros_message = _ros_message;
  {  // type
...
PyObject * rtabmap_ros__srv__global_bundle_adjustment__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._global_bundle_adjustment");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__global_bundle_adjustment__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._global_bundle_adjustment.GlobalBundleAdjustment_Response", full_classname_dest, 73) == 0);
  }
  rtabmap_ros__srv__GlobalBundleAdjustment_Response * ros_message = _ros_message;
