...
class GetMap_Response(metaclass=Metaclass_GetMap_Response):
    ...
    _fields_and_field_types = {
        'data': 'rtabmap_ros/MapData',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'MapData'),  # noqa: E501
    )
...
class Metaclass_GetMap(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _get_map
...
class GetMap(metaclass=Metaclass_GetMap):
    from rtabmap_ros.srv._get_map import GetMap_Request as Request
    from rtabmap_ros.srv._get_map import GetMap_Response as Response
