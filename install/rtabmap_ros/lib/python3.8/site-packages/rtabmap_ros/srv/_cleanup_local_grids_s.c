...
bool rtabmap_ros__srv__cleanup_local_grids__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._cleanup_local_grids.CleanupLocalGrids_Request", full_classname_dest, 62) == 0);
  }
  rtabmap_ros__srv__CleanupLocalGrids_Request * ros_message = _ros_message;
  {  // radius
...
PyObject * rtabmap_ros__srv__cleanup_local_grids__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._cleanup_local_grids");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__cleanup_local_grids__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._cleanup_local_grids.CleanupLocalGrids_Response", full_classname_dest, 63) == 0);
  }
  rtabmap_ros__srv__CleanupLocalGrids_Response * ros_message = _ros_message;
  {  // modified
