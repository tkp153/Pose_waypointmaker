...
class Metaclass_GetMap2(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _get_map2
...
class GetMap2(metaclass=Metaclass_GetMap2):
    from rtabmap_ros.srv._get_map2 import GetMap2_Request as Request
    from rtabmap_ros.srv._get_map2 import GetMap2_Response as Response
