...
bool rtabmap_ros__msg__key_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._key_point.KeyPoint", full_classname_dest, 35) == 0);
  }
  rtabmap_ros__msg__KeyPoint * ros_message = _ros_message;
  {  // pt
    PyObject * field = PyObject_GetAttrString(_pymsg, "pt");
    if (!field) {
      return false;
    }
    if (!rtabmap_ros__msg__point2f__convert_from_py(field, &ros_message->pt)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * rtabmap_ros__msg__key_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._key_point");
  ...
  {  // pt
    PyObject * field = NULL;
    field = rtabmap_ros__msg__point2f__convert_to_py(&ros_message->pt);
    if (!field) {
      return NULL;
    }
    {
