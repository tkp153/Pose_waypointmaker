...
bool rtabmap_ros__msg__user_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._user_data.UserData", full_classname_dest, 35) == 0);
  }
  rtabmap_ros__msg__UserData * ros_message = _ros_message;
  {  // header
  ...
  {  // cols
    ...
    assert(PyLong_Check(field));
    ros_message->cols = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // type
...
{
  /* NOTE(esteve): Call constructor of UserData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._user_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UserData");
