...
bool rtabmap_ros__msg__scan_descriptor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._scan_descriptor.ScanDescriptor", full_classname_dest, 47) == 0);
  }
  rtabmap_ros__msg__ScanDescriptor * ros_message = _ros_message;
  {  // header
...
PyObject * rtabmap_ros__msg__scan_descriptor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._scan_descriptor");
