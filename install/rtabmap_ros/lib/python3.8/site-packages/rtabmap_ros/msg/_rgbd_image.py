...
class RGBDImage(metaclass=Metaclass_RGBDImage):
    ...
    _fields_and_field_types = {
        ...
        'key_points': 'sequence<rtabmap_ros/KeyPoint>',
        'points': 'sequence<rtabmap_ros/Point3f>',
        'descriptors': 'sequence<uint8>',
        'global_descriptor': 'rtabmap_ros/GlobalDescriptor',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'GlobalDescriptor'),  # noqa: E501
    )
