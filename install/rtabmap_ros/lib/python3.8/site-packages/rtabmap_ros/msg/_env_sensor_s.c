...
bool rtabmap_ros__msg__env_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._env_sensor.EnvSensor", full_classname_dest, 37) == 0);
  }
  rtabmap_ros__msg__EnvSensor * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of EnvSensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._env_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EnvSensor");
