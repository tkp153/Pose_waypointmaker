...
class Metaclass_OdomInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.msg import CameraModels
...
class OdomInfo(metaclass=Metaclass_OdomInfo):
    ...
    _fields_and_field_types = {
        ...
        'local_bundle_models': 'sequence<rtabmap_ros/CameraModels>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'CameraModels')),  # noqa: E501
