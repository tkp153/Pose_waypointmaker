...
bool rtabmap_ros__msg__rgbd_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._rgbd_image.RGBDImage", full_classname_dest, 37) == 0);
  }
  rtabmap_ros__msg__RGBDImage * ros_message = _ros_message;
  {  // header
  ...
  {  // key_points
    ...
    rtabmap_ros__msg__KeyPoint * dest = ros_message->key_points.data;
  ...
  {  // points
    ...
    rtabmap_ros__msg__Point3f * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // global_descriptor
    ...
    if (!rtabmap_ros__msg__global_descriptor__convert_from_py(field, &ros_message->global_descriptor)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * rtabmap_ros__msg__rgbd_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._rgbd_image");
  ...
  {  // global_descriptor
    PyObject * field = NULL;
    field = rtabmap_ros__msg__global_descriptor__convert_to_py(&ros_message->global_descriptor);
    if (!field) {
      return NULL;
    }
    {
