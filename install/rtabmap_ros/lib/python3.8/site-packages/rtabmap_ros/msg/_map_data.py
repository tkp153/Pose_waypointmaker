...
class MapData(metaclass=Metaclass_MapData):
    ...
    _fields_and_field_types = {
        ...
        'graph': 'rtabmap_ros/MapGraph',
        'nodes': 'sequence<rtabmap_ros/NodeData>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'MapGraph'),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'nodes' field must be a set or sequence and each value of type 'NodeData'"
        self._nodes = value
