...
bool rtabmap_ros__msg__gps__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._gps.GPS", full_classname_dest, 24) == 0);
  }
  rtabmap_ros__msg__GPS * ros_message = _ros_message;
  {  // stamp
...
PyObject * rtabmap_ros__msg__gps__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._gps");
