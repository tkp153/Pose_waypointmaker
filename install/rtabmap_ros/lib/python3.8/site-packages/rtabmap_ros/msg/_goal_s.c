...
bool rtabmap_ros__msg__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._goal.Goal", full_classname_dest, 26) == 0);
  }
  rtabmap_ros__msg__Goal * ros_message = _ros_message;
  {  // header
...
PyObject * rtabmap_ros__msg__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._goal");
