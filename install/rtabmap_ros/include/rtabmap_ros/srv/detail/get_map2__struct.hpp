...
#ifndef RTABMAP_ROS__SRV__DETAIL__GET_MAP2__STRUCT_HPP_
#define RTABMAP_ROS__SRV__DETAIL__GET_MAP2__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rtabmap_ros__srv__GetMap2_Request __attribute__((deprecated))
#else
# define DEPRECATED__rtabmap_ros__srv__GetMap2_Request __declspec(deprecated)
#endif
...
struct GetMap2_Request_
{
  ...
  // pointer types
  using RawPtr =
    rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rtabmap_ros__srv__GetMap2_Request
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rtabmap_ros__srv__GetMap2_Request
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Request_<ContainerAllocator> const>
...
using GetMap2_Request =
  rtabmap_ros::srv::GetMap2_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__rtabmap_ros__srv__GetMap2_Response __attribute__((deprecated))
#else
# define DEPRECATED__rtabmap_ros__srv__GetMap2_Response __declspec(deprecated)
#endif
...
struct GetMap2_Response_
{
  ...
  // setters for named parameter idiom
  Type & set__data(
    const rtabmap_ros::msg::MapData_<ContainerAllocator> & _arg)
  {
    this->data = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rtabmap_ros__srv__GetMap2_Response
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rtabmap_ros__srv__GetMap2_Response
    std::shared_ptr<rtabmap_ros::srv::GetMap2_Response_<ContainerAllocator> const>
...
using GetMap2_Response =
  rtabmap_ros::srv::GetMap2_Response_<std::allocator<void>>;
...
struct GetMap2
{
  using Request = rtabmap_ros::srv::GetMap2_Request;
  using Response = rtabmap_ros::srv::GetMap2_Response;
};
...
#endif  // RTABMAP_ROS__SRV__DETAIL__GET_MAP2__STRUCT_HPP_
