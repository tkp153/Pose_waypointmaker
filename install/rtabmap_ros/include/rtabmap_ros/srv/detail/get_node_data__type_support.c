  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rtabmap_ros__srv__GetNodeData_Request__init(message_memory);
}

void GetNodeData_Request__rosidl_typesupport_introspection_c__GetNodeData_Request_fini_function(void * message_memory)
{
  rtabmap_ros__srv__GetNodeData_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetNodeData_Request__rosidl_typesupport_introspection_c__GetNodeData_Request_message_member_array[5] = {
  {
    ...
    offsetof(rtabmap_ros__srv__GetNodeData_Request, ids),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__srv__GetNodeData_Request, images),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__srv__GetNodeData_Request, scan),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__srv__GetNodeData_Request, grid),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__srv__GetNodeData_Request, user_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetNodeData_Request__rosidl_typesupport_introspection_c__GetNodeData_Request_message_members = {
  ...
  5,  // number of fields
  sizeof(rtabmap_ros__srv__GetNodeData_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GetNodeData_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  rtabmap_ros__srv__GetNodeData_Response__init(message_memory);
}

void GetNodeData_Response__rosidl_typesupport_introspection_c__GetNodeData_Response_fini_function(void * message_memory)
{
  rtabmap_ros__srv__GetNodeData_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember GetNodeData_Response__rosidl_typesupport_introspection_c__GetNodeData_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__srv__GetNodeData_Response, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers GetNodeData_Response__rosidl_typesupport_introspection_c__GetNodeData_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rtabmap_ros__srv__GetNodeData_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rtabmap_ros
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GetNodeData_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_members = {
  "rtabmap_ros__srv",  // service namespace
  "GetNodeData",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_Request_message_type_support_handle,
  NULL  // response message
  // rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_Response_message_type_support_handle
};

static rosidl_service_type_support_t rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_type_support_handle = {
  0,
  &rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GetNodeData)() {
  if (!rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_type_support_handle.typesupport_identifier) {
    rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GetNodeData_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GetNodeData_Response)()->data;
  }

  return &rtabmap_ros__srv__detail__get_node_data__rosidl_typesupport_introspection_c__GetNodeData_service_type_support_handle;
}
