...
{
  new (message_memory) rtabmap_ros::msg::RGBDImages(_init);
}

void RGBDImages_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_ros::msg::RGBDImages *>(message_memory);
  typed_message->~RGBDImages();
}

size_t size_function__RGBDImages__rgbd_images(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rtabmap_ros::msg::RGBDImage> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rtabmap_ros::msg::RGBDImage> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rtabmap_ros::msg::RGBDImage> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RGBDImages_message_member_array[2] = {
  {
    ...
    offsetof(rtabmap_ros::msg::RGBDImages, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rtabmap_ros::msg::RGBDImage>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::RGBDImages, rgbd_images),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RGBDImages_message_members = {
  ...
  2,  // number of fields
  sizeof(rtabmap_ros::msg::RGBDImages),
...
get_message_type_support_handle<rtabmap_ros::msg::RGBDImages>()
{
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::RGBDImages_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, msg, RGBDImages)() {
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::RGBDImages_message_type_support_handle;
}
