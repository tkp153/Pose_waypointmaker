...
{
  new (message_memory) rtabmap_ros::msg::CameraModel(_init);
}

void CameraModel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_ros::msg::CameraModel *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CameraModel_message_member_array[2] = {
  {
    ...
    offsetof(rtabmap_ros::msg::CameraModel, camera_info),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::CameraModel, local_transform),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CameraModel_message_members = {
  ...
  2,  // number of fields
  sizeof(rtabmap_ros::msg::CameraModel),
...
{
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::CameraModel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, msg, CameraModel)() {
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::CameraModel_message_type_support_handle;
}
