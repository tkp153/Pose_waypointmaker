...
rtabmap_ros__msg__OdomInfo__init(rtabmap_ros__msg__OdomInfo * msg)
{
  ...
  // local_bundle_models
  if (!rtabmap_ros__msg__CameraModels__Sequence__init(&msg->local_bundle_models, 0)) {
    rtabmap_ros__msg__OdomInfo__fini(msg);
    return false;
  }
  // local_bundle_poses
...
rtabmap_ros__msg__OdomInfo__fini(rtabmap_ros__msg__OdomInfo * msg)
{
  ...
  // local_bundle_models
  rtabmap_ros__msg__CameraModels__Sequence__fini(&msg->local_bundle_models);
  // local_bundle_poses
...
bool
rtabmap_ros__msg__OdomInfo__are_equal(const rtabmap_ros__msg__OdomInfo * lhs, const rtabmap_ros__msg__OdomInfo * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // local_bundle_models
  if (!rtabmap_ros__msg__CameraModels__Sequence__are_equal(
  ...
  // ref_corners
  if (!rtabmap_ros__msg__Point2f__Sequence__are_equal(
...
bool
rtabmap_ros__msg__OdomInfo__copy(
  const rtabmap_ros__msg__OdomInfo * input,
  rtabmap_ros__msg__OdomInfo * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // local_bundle_models
  if (!rtabmap_ros__msg__CameraModels__Sequence__copy(
  ...
  // ref_corners
  if (!rtabmap_ros__msg__Point2f__Sequence__copy(
...
rtabmap_ros__msg__OdomInfo__create()
{
  ...
  rtabmap_ros__msg__OdomInfo * msg = (rtabmap_ros__msg__OdomInfo *)allocator.allocate(sizeof(rtabmap_ros__msg__OdomInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__OdomInfo__Sequence__init(rtabmap_ros__msg__OdomInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__OdomInfo *)allocator.zero_allocate(size, sizeof(rtabmap_ros__msg__OdomInfo), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_ros__msg__OdomInfo__Sequence * array = (rtabmap_ros__msg__OdomInfo__Sequence *)allocator.allocate(sizeof(rtabmap_ros__msg__OdomInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rtabmap_ros__msg__OdomInfo__Sequence__are_equal(const rtabmap_ros__msg__OdomInfo__Sequence * lhs, const rtabmap_ros__msg__OdomInfo__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_ros__msg__OdomInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_ros__msg__OdomInfo__Sequence__copy(
  const rtabmap_ros__msg__OdomInfo__Sequence * input,
  rtabmap_ros__msg__OdomInfo__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_ros__msg__OdomInfo);
    rtabmap_ros__msg__OdomInfo * data =
      (rtabmap_ros__msg__OdomInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_ros__msg__OdomInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_ros__msg__OdomInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtabmap_ros__msg__OdomInfo__copy(
