...
bool
rtabmap_ros__msg__Point3f__are_equal(const rtabmap_ros__msg__Point3f * lhs, const rtabmap_ros__msg__Point3f * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rtabmap_ros__msg__Point3f__copy(
  const rtabmap_ros__msg__Point3f * input,
  rtabmap_ros__msg__Point3f * output)
{
  if (!input || !output) {
    return false;
  }
...
rtabmap_ros__msg__Point3f__create()
{
  ...
  rtabmap_ros__msg__Point3f * msg = (rtabmap_ros__msg__Point3f *)allocator.allocate(sizeof(rtabmap_ros__msg__Point3f), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__Point3f__Sequence__init(rtabmap_ros__msg__Point3f__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__Point3f *)allocator.zero_allocate(size, sizeof(rtabmap_ros__msg__Point3f), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_ros__msg__Point3f__Sequence * array = (rtabmap_ros__msg__Point3f__Sequence *)allocator.allocate(sizeof(rtabmap_ros__msg__Point3f__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rtabmap_ros__msg__Point3f__Sequence__are_equal(const rtabmap_ros__msg__Point3f__Sequence * lhs, const rtabmap_ros__msg__Point3f__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_ros__msg__Point3f__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_ros__msg__Point3f__Sequence__copy(
  const rtabmap_ros__msg__Point3f__Sequence * input,
  rtabmap_ros__msg__Point3f__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_ros__msg__Point3f);
    rtabmap_ros__msg__Point3f * data =
      (rtabmap_ros__msg__Point3f *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_ros__msg__Point3f__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_ros__msg__Point3f__fini(&data[i]);
        }
        free(data);
        return false;
      }
