...
{
  new (message_memory) rtabmap_ros::msg::MapData(_init);
}

void MapData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_ros::msg::MapData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MapData_message_member_array[3] = {
  {
    ...
    offsetof(rtabmap_ros::msg::MapData, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rtabmap_ros::msg::MapGraph>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::MapData, graph),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::MapData, nodes),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapData_message_members = {
  ...
  3,  // number of fields
  sizeof(rtabmap_ros::msg::MapData),
...
get_message_type_support_handle<rtabmap_ros::msg::MapData>()
{
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::MapData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, msg, MapData)() {
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::MapData_message_type_support_handle;
}
