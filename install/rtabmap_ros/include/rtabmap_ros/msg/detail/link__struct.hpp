...
#ifndef RTABMAP_ROS__MSG__DETAIL__LINK__STRUCT_HPP_
#define RTABMAP_ROS__MSG__DETAIL__LINK__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rtabmap_ros__msg__Link __attribute__((deprecated))
#else
# define DEPRECATED__rtabmap_ros__msg__Link __declspec(deprecated)
#endif
...
struct Link_
{
  ...
  using ConstRawPtr =
    const rtabmap_ros::msg::Link_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rtabmap_ros::msg::Link_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rtabmap_ros::msg::Link_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rtabmap_ros::msg::Link_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::Link_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::Link_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rtabmap_ros::msg::Link_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rtabmap_ros::msg::Link_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rtabmap_ros__msg__Link
    std::shared_ptr<rtabmap_ros::msg::Link_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rtabmap_ros__msg__Link
    std::shared_ptr<rtabmap_ros::msg::Link_<ContainerAllocator> const>
...
using Link =
  rtabmap_ros::msg::Link_<std::allocator<void>>;
...
#endif  // RTABMAP_ROS__MSG__DETAIL__LINK__STRUCT_HPP_
