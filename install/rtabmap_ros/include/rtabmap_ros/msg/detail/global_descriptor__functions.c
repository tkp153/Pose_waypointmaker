...
bool
rtabmap_ros__msg__GlobalDescriptor__are_equal(const rtabmap_ros__msg__GlobalDescriptor * lhs, const rtabmap_ros__msg__GlobalDescriptor * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rtabmap_ros__msg__GlobalDescriptor__copy(
  const rtabmap_ros__msg__GlobalDescriptor * input,
  rtabmap_ros__msg__GlobalDescriptor * output)
{
  if (!input || !output) {
    return false;
  }
...
rtabmap_ros__msg__GlobalDescriptor__create()
{
  ...
  rtabmap_ros__msg__GlobalDescriptor * msg = (rtabmap_ros__msg__GlobalDescriptor *)allocator.allocate(sizeof(rtabmap_ros__msg__GlobalDescriptor), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__GlobalDescriptor__Sequence__init(rtabmap_ros__msg__GlobalDescriptor__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__GlobalDescriptor *)allocator.zero_allocate(size, sizeof(rtabmap_ros__msg__GlobalDescriptor), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_ros__msg__GlobalDescriptor__Sequence * array = (rtabmap_ros__msg__GlobalDescriptor__Sequence *)allocator.allocate(sizeof(rtabmap_ros__msg__GlobalDescriptor__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rtabmap_ros__msg__GlobalDescriptor__Sequence__are_equal(const rtabmap_ros__msg__GlobalDescriptor__Sequence * lhs, const rtabmap_ros__msg__GlobalDescriptor__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_ros__msg__GlobalDescriptor__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_ros__msg__GlobalDescriptor__Sequence__copy(
  const rtabmap_ros__msg__GlobalDescriptor__Sequence * input,
  rtabmap_ros__msg__GlobalDescriptor__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_ros__msg__GlobalDescriptor);
    rtabmap_ros__msg__GlobalDescriptor * data =
      (rtabmap_ros__msg__GlobalDescriptor *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_ros__msg__GlobalDescriptor__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_ros__msg__GlobalDescriptor__fini(&data[i]);
        }
        free(data);
        return false;
      }
