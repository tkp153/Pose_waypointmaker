...
bool
rtabmap_ros__msg__Path__are_equal(const rtabmap_ros__msg__Path * lhs, const rtabmap_ros__msg__Path * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rtabmap_ros__msg__Path__copy(
  const rtabmap_ros__msg__Path * input,
  rtabmap_ros__msg__Path * output)
{
  if (!input || !output) {
    return false;
  }
...
rtabmap_ros__msg__Path__create()
{
  ...
  rtabmap_ros__msg__Path * msg = (rtabmap_ros__msg__Path *)allocator.allocate(sizeof(rtabmap_ros__msg__Path), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__Path__Sequence__init(rtabmap_ros__msg__Path__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__Path *)allocator.zero_allocate(size, sizeof(rtabmap_ros__msg__Path), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_ros__msg__Path__Sequence * array = (rtabmap_ros__msg__Path__Sequence *)allocator.allocate(sizeof(rtabmap_ros__msg__Path__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rtabmap_ros__msg__Path__Sequence__are_equal(const rtabmap_ros__msg__Path__Sequence * lhs, const rtabmap_ros__msg__Path__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_ros__msg__Path__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_ros__msg__Path__Sequence__copy(
  const rtabmap_ros__msg__Path__Sequence * input,
  rtabmap_ros__msg__Path__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_ros__msg__Path);
    rtabmap_ros__msg__Path * data =
      (rtabmap_ros__msg__Path *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_ros__msg__Path__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_ros__msg__Path__fini(&data[i]);
        }
        free(data);
        return false;
      }
