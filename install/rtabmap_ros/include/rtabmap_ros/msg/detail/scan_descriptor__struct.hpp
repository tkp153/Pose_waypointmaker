...
#ifndef RTABMAP_ROS__MSG__DETAIL__SCAN_DESCRIPTOR__STRUCT_HPP_
#define RTABMAP_ROS__MSG__DETAIL__SCAN_DESCRIPTOR__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rtabmap_ros__msg__ScanDescriptor __attribute__((deprecated))
#else
# define DEPRECATED__rtabmap_ros__msg__ScanDescriptor __declspec(deprecated)
#endif
...
struct ScanDescriptor_
{
  ...
  Type & set__global_descriptor(
    const rtabmap_ros::msg::GlobalDescriptor_<ContainerAllocator> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator> *;
  using ConstRawPtr =
    const rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rtabmap_ros__msg__ScanDescriptor
    std::shared_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rtabmap_ros__msg__ScanDescriptor
    std::shared_ptr<rtabmap_ros::msg::ScanDescriptor_<ContainerAllocator> const>
...
using ScanDescriptor =
  rtabmap_ros::msg::ScanDescriptor_<std::allocator<void>>;
...
#endif  // RTABMAP_ROS__MSG__DETAIL__SCAN_DESCRIPTOR__STRUCT_HPP_
