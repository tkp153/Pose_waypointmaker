...
{
  const auto * member = reinterpret_cast<const std::vector<rtabmap_ros::msg::CameraModels> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rtabmap_ros::msg::CameraModels> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rtabmap_ros::msg::CameraModels> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OdomInfo_message_member_array[45] = {
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rtabmap_ros::msg::CameraModels>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
