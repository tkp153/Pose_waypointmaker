...
{
  new (message_memory) rtabmap_ros::msg::GlobalDescriptor(_init);
}

void GlobalDescriptor_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_ros::msg::GlobalDescriptor *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GlobalDescriptor_message_member_array[4] = {
  {
    ...
    offsetof(rtabmap_ros::msg::GlobalDescriptor, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::GlobalDescriptor, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::GlobalDescriptor, info),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::GlobalDescriptor, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GlobalDescriptor_message_members = {
  ...
  4,  // number of fields
  sizeof(rtabmap_ros::msg::GlobalDescriptor),
...
{
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::GlobalDescriptor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, msg, GlobalDescriptor)() {
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::GlobalDescriptor_message_type_support_handle;
}
