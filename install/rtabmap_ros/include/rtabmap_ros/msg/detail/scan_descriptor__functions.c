...
bool
rtabmap_ros__msg__ScanDescriptor__are_equal(const rtabmap_ros__msg__ScanDescriptor * lhs, const rtabmap_ros__msg__ScanDescriptor * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rtabmap_ros__msg__ScanDescriptor__copy(
  const rtabmap_ros__msg__ScanDescriptor * input,
  rtabmap_ros__msg__ScanDescriptor * output)
{
  if (!input || !output) {
    return false;
  }
...
rtabmap_ros__msg__ScanDescriptor__create()
{
  ...
  rtabmap_ros__msg__ScanDescriptor * msg = (rtabmap_ros__msg__ScanDescriptor *)allocator.allocate(sizeof(rtabmap_ros__msg__ScanDescriptor), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__ScanDescriptor__Sequence__init(rtabmap_ros__msg__ScanDescriptor__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__ScanDescriptor *)allocator.zero_allocate(size, sizeof(rtabmap_ros__msg__ScanDescriptor), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_ros__msg__ScanDescriptor__Sequence * array = (rtabmap_ros__msg__ScanDescriptor__Sequence *)allocator.allocate(sizeof(rtabmap_ros__msg__ScanDescriptor__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rtabmap_ros__msg__ScanDescriptor__Sequence__are_equal(const rtabmap_ros__msg__ScanDescriptor__Sequence * lhs, const rtabmap_ros__msg__ScanDescriptor__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_ros__msg__ScanDescriptor__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_ros__msg__ScanDescriptor__Sequence__copy(
  const rtabmap_ros__msg__ScanDescriptor__Sequence * input,
  rtabmap_ros__msg__ScanDescriptor__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_ros__msg__ScanDescriptor);
    rtabmap_ros__msg__ScanDescriptor * data =
      (rtabmap_ros__msg__ScanDescriptor *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_ros__msg__ScanDescriptor__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_ros__msg__ScanDescriptor__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtabmap_ros__msg__ScanDescriptor__copy(
