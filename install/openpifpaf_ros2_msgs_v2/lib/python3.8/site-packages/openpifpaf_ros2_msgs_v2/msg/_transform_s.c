...
bool openpifpaf_ros2_msgs_v2__msg__transform__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("openpifpaf_ros2_msgs_v2.msg._transform.Transform", full_classname_dest, 48) == 0);
  }
  openpifpaf_ros2_msgs_v2__msg__Transform * ros_message = _ros_message;
  {  // transform
...
PyObject * openpifpaf_ros2_msgs_v2__msg__transform__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("openpifpaf_ros2_msgs_v2.msg._transform");
