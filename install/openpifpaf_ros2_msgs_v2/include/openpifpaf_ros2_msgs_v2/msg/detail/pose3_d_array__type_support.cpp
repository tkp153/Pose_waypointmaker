...
{
  new (message_memory) openpifpaf_ros2_msgs_v2::msg::Pose3DArray(_init);
}

void Pose3DArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<openpifpaf_ros2_msgs_v2::msg::Pose3DArray *>(message_memory);
  typed_message->~Pose3DArray();
}

size_t size_function__Pose3DArray__poses3d(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<openpifpaf_ros2_msgs_v2::msg::Pose3D> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<openpifpaf_ros2_msgs_v2::msg::Pose3D> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<openpifpaf_ros2_msgs_v2::msg::Pose3D> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose3DArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<openpifpaf_ros2_msgs_v2::msg::Pose3D>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2::msg::Pose3DArray, poses3d),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose3DArray_message_members = {
  ...
  1,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2::msg::Pose3DArray),
...
{
  return &::openpifpaf_ros2_msgs_v2::msg::rosidl_typesupport_introspection_cpp::Pose3DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openpifpaf_ros2_msgs_v2, msg, Pose3DArray)() {
  return &::openpifpaf_ros2_msgs_v2::msg::rosidl_typesupport_introspection_cpp::Pose3DArray_message_type_support_handle;
}
