...
#include <stddef.h>
#include "openpifpaf_ros2_msgs_v2/msg/detail/transforms__rosidl_typesupport_introspection_c.h"
...
// Member `transforms`
#include "openpifpaf_ros2_msgs_v2/msg/transform.h"
// Member `transforms`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  openpifpaf_ros2_msgs_v2__msg__Transforms__init(message_memory);
}

void Transforms__rosidl_typesupport_introspection_c__Transforms_fini_function(void * message_memory)
{
  openpifpaf_ros2_msgs_v2__msg__Transforms__fini(message_memory);
}

size_t Transforms__rosidl_typesupport_introspection_c__size_function__Transform__transforms(
  const void * untyped_member)
{
  const openpifpaf_ros2_msgs_v2__msg__Transform__Sequence * member =
    (const openpifpaf_ros2_msgs_v2__msg__Transform__Sequence *)(untyped_member);
  return member->size;
}
...
{
  openpifpaf_ros2_msgs_v2__msg__Transform__Sequence * member =
    (openpifpaf_ros2_msgs_v2__msg__Transform__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  openpifpaf_ros2_msgs_v2__msg__Transform__Sequence * member =
    (openpifpaf_ros2_msgs_v2__msg__Transform__Sequence *)(untyped_member);
  openpifpaf_ros2_msgs_v2__msg__Transform__Sequence__fini(member);
  return openpifpaf_ros2_msgs_v2__msg__Transform__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Transforms__rosidl_typesupport_introspection_c__Transforms_message_member_array[1] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs_v2__msg__Transforms, transforms),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Transforms__rosidl_typesupport_introspection_c__Transforms_message_members = {
  ...
  1,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2__msg__Transforms),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openpifpaf_ros2_msgs_v2, msg, Transforms)() {
