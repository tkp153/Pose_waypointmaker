...
{
  new (message_memory) openpifpaf_ros2_msgs_v2::msg::Transform(_init);
}

void Transform_fini_function(void * message_memory)
{
  auto typed_message = static_cast<openpifpaf_ros2_msgs_v2::msg::Transform *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Transform_message_member_array[1] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs_v2::msg::Transform, transform),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Transform_message_members = {
  ...
  1,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2::msg::Transform),
...
{
  return &::openpifpaf_ros2_msgs_v2::msg::rosidl_typesupport_introspection_cpp::Transform_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openpifpaf_ros2_msgs_v2, msg, Transform)() {
  return &::openpifpaf_ros2_msgs_v2::msg::rosidl_typesupport_introspection_cpp::Transform_message_type_support_handle;
}
