...
static const _Transforms_type_support_symbol_names_t _Transforms_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, openpifpaf_ros2_msgs, msg, Transforms)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, openpifpaf_ros2_msgs, msg, Transforms)),
  }
};
...
{
  return &::openpifpaf_ros2_msgs::msg::rosidl_typesupport_cpp::Transforms_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, openpifpaf_ros2_msgs, msg, Transforms)() {
  return get_message_type_support_handle<openpifpaf_ros2_msgs::msg::Transforms>();
}
