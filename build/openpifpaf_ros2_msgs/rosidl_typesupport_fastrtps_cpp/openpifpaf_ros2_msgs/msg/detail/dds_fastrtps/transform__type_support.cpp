...
#include "openpifpaf_ros2_msgs/msg/detail/transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const openpifpaf_ros2_msgs::msg::Transform *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<openpifpaf_ros2_msgs::msg::Transform *>(
    untyped_ros_message);
...
{
  return &openpifpaf_ros2_msgs::msg::typesupport_fastrtps_cpp::_Transform__handle;
}
