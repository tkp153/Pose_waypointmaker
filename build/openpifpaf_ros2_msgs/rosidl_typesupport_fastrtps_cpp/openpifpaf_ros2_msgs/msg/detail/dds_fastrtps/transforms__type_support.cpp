...
#include "openpifpaf_ros2_msgs/msg/detail/transforms__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const openpifpaf_ros2_msgs::msg::Transform &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  openpifpaf_ros2_msgs::msg::Transform &);
...
cdr_serialize(
  const openpifpaf_ros2_msgs::msg::Transforms & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  openpifpaf_ros2_msgs::msg::Transforms & ros_message)
{
  // Member: transforms
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: transforms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        openpifpaf_ros2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Transform(
...
{
  auto typed_message =
    static_cast<const openpifpaf_ros2_msgs::msg::Transforms *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<openpifpaf_ros2_msgs::msg::Transforms *>(
    untyped_ros_message);
...
{
  return &openpifpaf_ros2_msgs::msg::typesupport_fastrtps_cpp::_Transforms__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, openpifpaf_ros2_msgs, msg, Transforms)() {
  return &openpifpaf_ros2_msgs::msg::typesupport_fastrtps_cpp::_Transforms__handle;
}
