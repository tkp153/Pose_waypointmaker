...
openpifpaf_ros2_msgs__msg__Transforms__init(openpifpaf_ros2_msgs__msg__Transforms * msg)
{
  ...
  // transforms
  if (!openpifpaf_ros2_msgs__msg__Transform__Sequence__init(&msg->transforms, 0)) {
    openpifpaf_ros2_msgs__msg__Transforms__fini(msg);
    return false;
  }
  return true;
}
...
openpifpaf_ros2_msgs__msg__Transforms__fini(openpifpaf_ros2_msgs__msg__Transforms * msg)
{
  ...
  // transforms
  openpifpaf_ros2_msgs__msg__Transform__Sequence__fini(&msg->transforms);
}
...
openpifpaf_ros2_msgs__msg__Transforms__are_equal(const openpifpaf_ros2_msgs__msg__Transforms * lhs, const openpifpaf_ros2_msgs__msg__Transforms * rhs)
{
  ...
  // transforms
  if (!openpifpaf_ros2_msgs__msg__Transform__Sequence__are_equal(
  ...
  openpifpaf_ros2_msgs__msg__Transforms * output)
{
  ...
  // transforms
  if (!openpifpaf_ros2_msgs__msg__Transform__Sequence__copy(
...
openpifpaf_ros2_msgs__msg__Transforms__create()
{
  ...
  openpifpaf_ros2_msgs__msg__Transforms * msg = (openpifpaf_ros2_msgs__msg__Transforms *)allocator.allocate(sizeof(openpifpaf_ros2_msgs__msg__Transforms), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(openpifpaf_ros2_msgs__msg__Transforms));
  bool success = openpifpaf_ros2_msgs__msg__Transforms__init(msg);
  if (!success) {
...
openpifpaf_ros2_msgs__msg__Transforms__Sequence__init(openpifpaf_ros2_msgs__msg__Transforms__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  openpifpaf_ros2_msgs__msg__Transforms * data = NULL;

  if (size) {
    data = (openpifpaf_ros2_msgs__msg__Transforms *)allocator.zero_allocate(size, sizeof(openpifpaf_ros2_msgs__msg__Transforms), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = openpifpaf_ros2_msgs__msg__Transforms__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        openpifpaf_ros2_msgs__msg__Transforms__fini(&data[i - 1]);
      }
...
openpifpaf_ros2_msgs__msg__Transforms__Sequence__fini(openpifpaf_ros2_msgs__msg__Transforms__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      openpifpaf_ros2_msgs__msg__Transforms__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  openpifpaf_ros2_msgs__msg__Transforms__Sequence * array = (openpifpaf_ros2_msgs__msg__Transforms__Sequence *)allocator.allocate(sizeof(openpifpaf_ros2_msgs__msg__Transforms__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = openpifpaf_ros2_msgs__msg__Transforms__Sequence__init(array, size);
  if (!success) {
...
openpifpaf_ros2_msgs__msg__Transforms__Sequence__destroy(openpifpaf_ros2_msgs__msg__Transforms__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    openpifpaf_ros2_msgs__msg__Transforms__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
openpifpaf_ros2_msgs__msg__Transforms__Sequence__are_equal(const openpifpaf_ros2_msgs__msg__Transforms__Sequence * lhs, const openpifpaf_ros2_msgs__msg__Transforms__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!openpifpaf_ros2_msgs__msg__Transforms__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  openpifpaf_ros2_msgs__msg__Transforms__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(openpifpaf_ros2_msgs__msg__Transforms);
    openpifpaf_ros2_msgs__msg__Transforms * data =
      (openpifpaf_ros2_msgs__msg__Transforms *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!openpifpaf_ros2_msgs__msg__Transforms__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          openpifpaf_ros2_msgs__msg__Transforms__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!openpifpaf_ros2_msgs__msg__Transforms__copy(
