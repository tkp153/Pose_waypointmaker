...
#include <stddef.h>
#include "openpifpaf_ros2_msgs_v2/msg/detail/poses__rosidl_typesupport_introspection_c.h"
...
// Member `poses`
#include "openpifpaf_ros2_msgs_v2/msg/pose.h"
// Member `poses`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  openpifpaf_ros2_msgs_v2__msg__Poses__init(message_memory);
}

void Poses__rosidl_typesupport_introspection_c__Poses_fini_function(void * message_memory)
{
  openpifpaf_ros2_msgs_v2__msg__Poses__fini(message_memory);
}

size_t Poses__rosidl_typesupport_introspection_c__size_function__Pose__poses(
  const void * untyped_member)
{
  const openpifpaf_ros2_msgs_v2__msg__Pose__Sequence * member =
    (const openpifpaf_ros2_msgs_v2__msg__Pose__Sequence *)(untyped_member);
  return member->size;
}
...
{
  openpifpaf_ros2_msgs_v2__msg__Pose__Sequence * member =
    (openpifpaf_ros2_msgs_v2__msg__Pose__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  openpifpaf_ros2_msgs_v2__msg__Pose__Sequence * member =
    (openpifpaf_ros2_msgs_v2__msg__Pose__Sequence *)(untyped_member);
  openpifpaf_ros2_msgs_v2__msg__Pose__Sequence__fini(member);
  return openpifpaf_ros2_msgs_v2__msg__Pose__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Poses__rosidl_typesupport_introspection_c__Poses_message_member_array[2] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs_v2__msg__Poses, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Poses, poses),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Poses__rosidl_typesupport_introspection_c__Poses_message_members = {
  ...
  "Poses",  // message name
  2,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2__msg__Poses),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openpifpaf_ros2_msgs_v2, msg, Poses)() {
