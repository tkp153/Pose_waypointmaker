...
#include <stddef.h>
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose3_d_array__rosidl_typesupport_introspection_c.h"
...
// Member `poses3d`
#include "openpifpaf_ros2_msgs_v2/msg/pose3_d.h"
// Member `poses3d`
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose3_d__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  openpifpaf_ros2_msgs_v2__msg__Pose3DArray__init(message_memory);
}

void Pose3DArray__rosidl_typesupport_introspection_c__Pose3DArray_fini_function(void * message_memory)
{
  openpifpaf_ros2_msgs_v2__msg__Pose3DArray__fini(message_memory);
}

size_t Pose3DArray__rosidl_typesupport_introspection_c__size_function__Pose3D__poses3d(
  const void * untyped_member)
{
  const openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence * member =
    (const openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence *)(untyped_member);
  return member->size;
}
...
{
  openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence * member =
    (openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence * member =
    (openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence *)(untyped_member);
  openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence__fini(member);
  return openpifpaf_ros2_msgs_v2__msg__Pose3D__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pose3DArray__rosidl_typesupport_introspection_c__Pose3DArray_message_member_array[1] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3DArray, poses3d),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Pose3DArray__rosidl_typesupport_introspection_c__Pose3DArray_message_members = {
  ...
  1,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2__msg__Pose3DArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openpifpaf_ros2_msgs_v2, msg, Pose3DArray)() {
  Pose3DArray__rosidl_typesupport_introspection_c__Pose3DArray_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openpifpaf_ros2_msgs_v2, msg, Pose3D)();
