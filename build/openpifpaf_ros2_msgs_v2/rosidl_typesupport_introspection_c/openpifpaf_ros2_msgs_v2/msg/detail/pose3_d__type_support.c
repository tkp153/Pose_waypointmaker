  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  openpifpaf_ros2_msgs_v2__msg__Pose3D__init(message_memory);
}

void Pose3D__rosidl_typesupport_introspection_c__Pose3D_fini_function(void * message_memory)
{
  openpifpaf_ros2_msgs_v2__msg__Pose3D__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Pose3D__rosidl_typesupport_introspection_c__Pose3D_message_member_array[7] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, pos_x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, pos_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, pos_z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, dir_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, dir_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Pose3D, dir_z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Pose3D__rosidl_typesupport_introspection_c__Pose3D_message_members = {
  ...
  "Pose3D",  // message name
  7,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2__msg__Pose3D),
