...
#include <stddef.h>
#include "openpifpaf_ros2_msgs_v2/msg/detail/person__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  openpifpaf_ros2_msgs_v2__msg__Person__init(message_memory);
}

void Person__rosidl_typesupport_introspection_c__Person_fini_function(void * message_memory)
{
  openpifpaf_ros2_msgs_v2__msg__Person__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Person__rosidl_typesupport_introspection_c__Person_message_member_array[3] = {
  {
    ...
    offsetof(openpifpaf_ros2_msgs_v2__msg__Person, markers),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Person, person_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(openpifpaf_ros2_msgs_v2__msg__Person, human_person_num),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Person__rosidl_typesupport_introspection_c__Person_message_members = {
  ...
  "Person",  // message name
  3,  // number of fields
  sizeof(openpifpaf_ros2_msgs_v2__msg__Person),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, openpifpaf_ros2_msgs_v2, msg, Person)() {
