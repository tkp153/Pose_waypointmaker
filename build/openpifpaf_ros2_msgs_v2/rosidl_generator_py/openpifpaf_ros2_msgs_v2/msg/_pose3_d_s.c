...
bool openpifpaf_ros2_msgs_v2__msg__pose3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("openpifpaf_ros2_msgs_v2.msg._pose3_d.Pose3D", full_classname_dest, 43) == 0);
  }
  openpifpaf_ros2_msgs_v2__msg__Pose3D * ros_message = _ros_message;
  {  // pos_x
...
PyObject * openpifpaf_ros2_msgs_v2__msg__pose3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("openpifpaf_ros2_msgs_v2.msg._pose3_d");
