...
#include "openpifpaf_ros2_msgs_v2/msg/detail/transform__rosidl_typesupport_fastrtps_c.h"
...
using _Transform__ros_msg_type = openpifpaf_ros2_msgs_v2__msg__Transform;
...
static uint32_t _Transform__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_openpifpaf_ros2_msgs_v2__msg__Transform(
...
{
  return max_serialized_size_openpifpaf_ros2_msgs_v2__msg__Transform(
    full_bounded, 0);
}
