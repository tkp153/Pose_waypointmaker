...
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose3_d__rosidl_typesupport_fastrtps_c.h"
...
using _Pose3D__ros_msg_type = openpifpaf_ros2_msgs_v2__msg__Pose3D;
...
static uint32_t _Pose3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_openpifpaf_ros2_msgs_v2__msg__Pose3D(
...
{
  return max_serialized_size_openpifpaf_ros2_msgs_v2__msg__Pose3D(
    full_bounded, 0);
}
