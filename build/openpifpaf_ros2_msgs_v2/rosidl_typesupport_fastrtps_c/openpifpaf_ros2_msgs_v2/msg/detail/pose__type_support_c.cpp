...
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = openpifpaf_ros2_msgs_v2__msg__Pose;
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_openpifpaf_ros2_msgs_v2__msg__Pose(
...
{
  return max_serialized_size_openpifpaf_ros2_msgs_v2__msg__Pose(
    full_bounded, 0);
}
