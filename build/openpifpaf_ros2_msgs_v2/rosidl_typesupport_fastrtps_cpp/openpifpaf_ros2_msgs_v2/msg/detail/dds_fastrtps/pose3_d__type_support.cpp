...
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const openpifpaf_ros2_msgs_v2::msg::Pose3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<openpifpaf_ros2_msgs_v2::msg::Pose3D *>(
    untyped_ros_message);
...
{
  return &openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::_Pose3D__handle;
}
