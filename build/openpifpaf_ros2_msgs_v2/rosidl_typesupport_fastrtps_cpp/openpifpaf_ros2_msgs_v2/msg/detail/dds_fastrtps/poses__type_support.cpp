...
#include "openpifpaf_ros2_msgs_v2/msg/detail/poses__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const openpifpaf_ros2_msgs_v2::msg::Pose &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  openpifpaf_ros2_msgs_v2::msg::Pose &);
size_t get_serialized_size(
  const openpifpaf_ros2_msgs_v2::msg::Pose &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const openpifpaf_ros2_msgs_v2::msg::Poses & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  openpifpaf_ros2_msgs_v2::msg::Poses & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const openpifpaf_ros2_msgs_v2::msg::Poses *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<openpifpaf_ros2_msgs_v2::msg::Poses *>(
    untyped_ros_message);
...
{
  return &openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::_Poses__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, openpifpaf_ros2_msgs_v2, msg, Poses)() {
  return &openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::_Poses__handle;
}
