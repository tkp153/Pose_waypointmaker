...
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose3_d_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const openpifpaf_ros2_msgs_v2::msg::Pose3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  openpifpaf_ros2_msgs_v2::msg::Pose3D &);
  ...
  size_t current_alignment)
{
  ...
  // Member: poses3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose3D(
...
{
  auto typed_message =
    static_cast<const openpifpaf_ros2_msgs_v2::msg::Pose3DArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<openpifpaf_ros2_msgs_v2::msg::Pose3DArray *>(
    untyped_ros_message);
...
{
  return &openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::_Pose3DArray__handle;
}
