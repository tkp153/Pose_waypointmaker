...
#include "openpifpaf_ros2_msgs_v2/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const openpifpaf_ros2_msgs_v2::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<openpifpaf_ros2_msgs_v2::msg::Pose *>(
    untyped_ros_message);
...
{
  return &openpifpaf_ros2_msgs_v2::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
