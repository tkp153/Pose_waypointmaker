...
public:
    ...
    {
        multiSessionLocSubView->setWindowTitle(QApplication::translate("multiSessionLocSubView", "Form", nullptr));
        label->setText(QApplication::translate("multiSessionLocSubView", "Map 0", nullptr));
    } // retranslateUi
