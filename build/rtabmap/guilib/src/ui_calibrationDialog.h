...
public:
    ...
    void setupUi(QDialog *calibrationDialog)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 357, 820));
...
#endif // QT_NO_TOOLTIP
        label_20->setText(QApplication::translate("calibrationDialog", "<html><head/><body><p><a href=\"https://github.com/introlab/rtabmap/raw/master/data/check-108.pdf\"><span style=\" text-decoration: underline; color:#0000ff;\">Sample8x6</span></a></p></body></html>", nullptr));
#ifndef QT_NO_TOOLTIP
