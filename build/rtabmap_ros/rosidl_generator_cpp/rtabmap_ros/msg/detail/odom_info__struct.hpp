...
struct OdomInfo_
{
  ...
  using _local_bundle_models_type =
    std::vector<rtabmap_ros::msg::CameraModels_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_ros::msg::CameraModels_<ContainerAllocator>>::other>;
  ...
  Type & set__local_bundle_models(
    const std::vector<rtabmap_ros::msg::CameraModels_<ContainerAllocator>, typename ContainerAllocator::template rebind<rtabmap_ros::msg::CameraModels_<ContainerAllocator>>::other> & _arg)
  {
