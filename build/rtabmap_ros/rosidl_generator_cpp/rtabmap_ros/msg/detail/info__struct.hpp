...
#ifndef RTABMAP_ROS__MSG__DETAIL__INFO__STRUCT_HPP_
#define RTABMAP_ROS__MSG__DETAIL__INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rtabmap_ros__msg__Info __attribute__((deprecated))
#else
# define DEPRECATED__rtabmap_ros__msg__Info __declspec(deprecated)
#endif
...
struct Info_
{
  ...
  // pointer types
  using RawPtr =
    rtabmap_ros::msg::Info_<ContainerAllocator> *;
  using ConstRawPtr =
    const rtabmap_ros::msg::Info_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rtabmap_ros::msg::Info_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rtabmap_ros::msg::Info_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rtabmap_ros::msg::Info_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::Info_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rtabmap_ros::msg::Info_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rtabmap_ros::msg::Info_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rtabmap_ros::msg::Info_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rtabmap_ros__msg__Info
    std::shared_ptr<rtabmap_ros::msg::Info_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rtabmap_ros__msg__Info
    std::shared_ptr<rtabmap_ros::msg::Info_<ContainerAllocator> const>
...
using Info =
  rtabmap_ros::msg::Info_<std::allocator<void>>;
...
#endif  // RTABMAP_ROS__MSG__DETAIL__INFO__STRUCT_HPP_
