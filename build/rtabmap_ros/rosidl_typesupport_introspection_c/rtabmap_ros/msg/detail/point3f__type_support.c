  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rtabmap_ros__msg__Point3f__init(message_memory);
}

void Point3f__rosidl_typesupport_introspection_c__Point3f_fini_function(void * message_memory)
{
  rtabmap_ros__msg__Point3f__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Point3f__rosidl_typesupport_introspection_c__Point3f_message_member_array[3] = {
  {
    ...
    offsetof(rtabmap_ros__msg__Point3f, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__msg__Point3f, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros__msg__Point3f, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Point3f__rosidl_typesupport_introspection_c__Point3f_message_members = {
  ...
  3,  // number of fields
  sizeof(rtabmap_ros__msg__Point3f),
