...
#include "rtabmap_ros/srv/detail/get_node_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_ros::srv::GetNodeData_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::GetNodeData_Request & ros_message)
{
  // Member: ids
  {
    cdr >> ros_message.ids;
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::GetNodeData_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::GetNodeData_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetNodeData_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetNodeData_Request)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetNodeData_Request__handle;
}
...
{
bool cdr_serialize(
  const rtabmap_ros::msg::NodeData &,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_ros
cdr_serialize(
  const rtabmap_ros::srv::GetNodeData_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::GetNodeData_Response & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_NodeData(
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::GetNodeData_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::GetNodeData_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetNodeData_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetNodeData_Response)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetNodeData_Response__handle;
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetNodeData__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetNodeData)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetNodeData__handle;
}
