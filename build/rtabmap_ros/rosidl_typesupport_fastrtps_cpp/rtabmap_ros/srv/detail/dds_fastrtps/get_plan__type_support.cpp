...
#include "rtabmap_ros/srv/detail/get_plan__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_ros::srv::GetPlan_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::GetPlan_Request & ros_message)
{
  // Member: goal_node
  cdr >> ros_message.goal_node;
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::GetPlan_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::GetPlan_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetPlan_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetPlan_Request)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetPlan_Request__handle;
}
...
{
bool cdr_serialize(
  const rtabmap_ros::msg::Path &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rtabmap_ros::msg::Path &);
size_t get_serialized_size(
  const rtabmap_ros::msg::Path &,
  size_t current_alignment);
size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_ros
cdr_serialize(
  const rtabmap_ros::srv::GetPlan_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: plan
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::GetPlan_Response & ros_message)
{
  // Member: plan
  ...
  size_t current_alignment)
{
  ...
  // Member: plan
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_Path(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::GetPlan_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::GetPlan_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetPlan_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetPlan_Response)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetPlan_Response__handle;
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetPlan__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetPlan)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetPlan__handle;
}
