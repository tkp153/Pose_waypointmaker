...
#include "rtabmap_ros/srv/detail/load_database__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_ros::srv::LoadDatabase_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::LoadDatabase_Request & ros_message)
{
  // Member: database_path
  cdr >> ros_message.database_path;
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::LoadDatabase_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::LoadDatabase_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_LoadDatabase_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, LoadDatabase_Request)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_LoadDatabase_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_ros
cdr_serialize(
  const rtabmap_ros::srv::LoadDatabase_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::LoadDatabase_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::LoadDatabase_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::LoadDatabase_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_LoadDatabase_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, LoadDatabase_Response)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_LoadDatabase_Response__handle;
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_LoadDatabase__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, LoadDatabase)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_LoadDatabase__handle;
}
