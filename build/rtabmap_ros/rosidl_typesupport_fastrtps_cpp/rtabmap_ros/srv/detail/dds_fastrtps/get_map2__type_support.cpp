...
#include "rtabmap_ros/srv/detail/get_map2__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_ros::srv::GetMap2_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::GetMap2_Request & ros_message)
{
  // Member: global_map
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::GetMap2_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::GetMap2_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetMap2_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetMap2_Request)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetMap2_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rtabmap_ros
cdr_serialize(
  const rtabmap_ros::srv::GetMap2_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: data
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::srv::GetMap2_Response & ros_message)
{
  // Member: data
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::GetMap2_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::GetMap2_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetMap2_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetMap2_Response)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetMap2_Response__handle;
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetMap2__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, GetMap2)() {
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_GetMap2__handle;
}
