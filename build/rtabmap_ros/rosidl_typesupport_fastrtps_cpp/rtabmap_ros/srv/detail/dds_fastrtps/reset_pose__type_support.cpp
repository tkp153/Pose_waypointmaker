...
#include "rtabmap_ros/srv/detail/reset_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::ResetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::ResetPose_Request *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_ResetPose_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::srv::ResetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rtabmap_ros::srv::ResetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_ResetPose_Response__handle;
}
...
{
  return &rtabmap_ros::srv::typesupport_fastrtps_cpp::_ResetPose__handle;
}
