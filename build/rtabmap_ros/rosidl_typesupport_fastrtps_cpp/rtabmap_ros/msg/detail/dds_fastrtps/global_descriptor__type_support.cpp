...
#include "rtabmap_ros/msg/detail/global_descriptor__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::msg::GlobalDescriptor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::msg::GlobalDescriptor *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_GlobalDescriptor__handle;
}
