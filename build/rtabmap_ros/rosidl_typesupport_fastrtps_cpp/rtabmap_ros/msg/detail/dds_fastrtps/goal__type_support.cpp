...
#include "rtabmap_ros/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_ros::msg::Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::msg::Goal & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::msg::Goal *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, msg, Goal)() {
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
