...
#include "rtabmap_ros/msg/detail/camera_models__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rtabmap_ros::msg::CameraModel &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rtabmap_ros::msg::CameraModel &);
...
cdr_serialize(
  const rtabmap_ros::msg::CameraModels & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::msg::CameraModels & ros_message)
{
  // Member: models
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: models
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rtabmap_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_CameraModel(
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::msg::CameraModels *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::msg::CameraModels *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_CameraModels__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, msg, CameraModels)() {
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_CameraModels__handle;
}
