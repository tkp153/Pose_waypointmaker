...
#include "rtabmap_ros/msg/detail/rgbd_image__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rtabmap_ros::msg::RGBDImage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rtabmap_ros::msg::RGBDImage & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const rtabmap_ros::msg::RGBDImage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rtabmap_ros::msg::RGBDImage *>(
    untyped_ros_message);
...
{
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_RGBDImage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, msg, RGBDImage)() {
  return &rtabmap_ros::msg::typesupport_fastrtps_cpp::_RGBDImage__handle;
}
