...
static const _LoadDatabase_Request_type_support_symbol_names_t _LoadDatabase_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, LoadDatabase_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, LoadDatabase_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_ros, srv, LoadDatabase_Request)() {
  return &::rtabmap_ros::srv::rosidl_typesupport_c::LoadDatabase_Request_message_type_support_handle;
}
...
static const _LoadDatabase_Response_type_support_symbol_names_t _LoadDatabase_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, LoadDatabase_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, LoadDatabase_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_rtabmap_ros
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_ros, srv, LoadDatabase_Response)() {
  return &::rtabmap_ros::srv::rosidl_typesupport_c::LoadDatabase_Response_message_type_support_handle;
}
...
static const _LoadDatabase_type_support_symbol_names_t _LoadDatabase_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, LoadDatabase)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, LoadDatabase)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_ros, srv, LoadDatabase)() {
  return &::rtabmap_ros::srv::rosidl_typesupport_c::LoadDatabase_service_type_support_handle;
}
