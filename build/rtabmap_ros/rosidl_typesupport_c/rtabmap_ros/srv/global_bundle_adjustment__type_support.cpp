...
static const _GlobalBundleAdjustment_Request_type_support_symbol_names_t _GlobalBundleAdjustment_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, GlobalBundleAdjustment_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GlobalBundleAdjustment_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_ros, srv, GlobalBundleAdjustment_Request)() {
  return &::rtabmap_ros::srv::rosidl_typesupport_c::GlobalBundleAdjustment_Request_message_type_support_handle;
}
...
static const _GlobalBundleAdjustment_Response_type_support_symbol_names_t _GlobalBundleAdjustment_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, GlobalBundleAdjustment_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GlobalBundleAdjustment_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_rtabmap_ros
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_ros, srv, GlobalBundleAdjustment_Response)() {
  return &::rtabmap_ros::srv::rosidl_typesupport_c::GlobalBundleAdjustment_Response_message_type_support_handle;
}
...
static const _GlobalBundleAdjustment_type_support_symbol_names_t _GlobalBundleAdjustment_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, GlobalBundleAdjustment)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rtabmap_ros, srv, GlobalBundleAdjustment)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rtabmap_ros, srv, GlobalBundleAdjustment)() {
  return &::rtabmap_ros::srv::rosidl_typesupport_c::GlobalBundleAdjustment_service_type_support_handle;
}
