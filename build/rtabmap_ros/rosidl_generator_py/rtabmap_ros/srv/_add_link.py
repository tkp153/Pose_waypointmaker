...
class Metaclass_AddLink_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.msg import Link
...
class AddLink_Request(metaclass=Metaclass_AddLink_Request):
    ...
    _fields_and_field_types = {
        'link': 'rtabmap_ros/Link',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'Link'),  # noqa: E501
    )
...
class Metaclass_AddLink(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _add_link
...
class AddLink(metaclass=Metaclass_AddLink):
    from rtabmap_ros.srv._add_link import AddLink_Request as Request
    from rtabmap_ros.srv._add_link import AddLink_Response as Response
