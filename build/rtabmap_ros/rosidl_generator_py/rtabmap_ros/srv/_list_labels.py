...
class Metaclass_ListLabels(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _list_labels
...
class ListLabels(metaclass=Metaclass_ListLabels):
    from rtabmap_ros.srv._list_labels import ListLabels_Request as Request
    from rtabmap_ros.srv._list_labels import ListLabels_Response as Response
