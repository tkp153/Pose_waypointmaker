...
bool rtabmap_ros__srv__get_map2__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._get_map2.GetMap2_Request", full_classname_dest, 41) == 0);
  }
  rtabmap_ros__srv__GetMap2_Request * ros_message = _ros_message;
  {  // global_map
...
PyObject * rtabmap_ros__srv__get_map2__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._get_map2");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__get_map2__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._get_map2.GetMap2_Response", full_classname_dest, 42) == 0);
  }
  rtabmap_ros__srv__GetMap2_Response * ros_message = _ros_message;
  {  // data
