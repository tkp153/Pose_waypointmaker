...
bool rtabmap_ros__srv__list_labels__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._list_labels.ListLabels_Request", full_classname_dest, 47) == 0);
  }
  rtabmap_ros__srv__ListLabels_Request * ros_message = _ros_message;
...
PyObject * rtabmap_ros__srv__list_labels__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._list_labels");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__list_labels__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._list_labels.ListLabels_Response", full_classname_dest, 48) == 0);
  }
  rtabmap_ros__srv__ListLabels_Response * ros_message = _ros_message;
  {  // ids
