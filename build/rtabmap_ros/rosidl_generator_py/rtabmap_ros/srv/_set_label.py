...
class Metaclass_SetLabel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _set_label
...
class SetLabel(metaclass=Metaclass_SetLabel):
    from rtabmap_ros.srv._set_label import SetLabel_Request as Request
    from rtabmap_ros.srv._set_label import SetLabel_Response as Response
