...
class Metaclass_GlobalBundleAdjustment(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rtabmap_ros.srv.GlobalBundleAdjustment')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rtabmap_ros.srv import _global_bundle_adjustment
...
class GlobalBundleAdjustment(metaclass=Metaclass_GlobalBundleAdjustment):
    from rtabmap_ros.srv._global_bundle_adjustment import GlobalBundleAdjustment_Request as Request
    from rtabmap_ros.srv._global_bundle_adjustment import GlobalBundleAdjustment_Response as Response
