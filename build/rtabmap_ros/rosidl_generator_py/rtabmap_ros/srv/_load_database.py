...
class Metaclass_LoadDatabase(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _load_database
...
class LoadDatabase(metaclass=Metaclass_LoadDatabase):
    from rtabmap_ros.srv._load_database import LoadDatabase_Request as Request
    from rtabmap_ros.srv._load_database import LoadDatabase_Response as Response
