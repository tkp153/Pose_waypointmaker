...
class Metaclass_GetPlan_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.msg import Path
...
class GetPlan_Response(metaclass=Metaclass_GetPlan_Response):
    ...
    _fields_and_field_types = {
        'plan': 'rtabmap_ros/Path',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'Path'),  # noqa: E501
    )
...
class Metaclass_GetPlan(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _get_plan
...
class GetPlan(metaclass=Metaclass_GetPlan):
    from rtabmap_ros.srv._get_plan import GetPlan_Request as Request
    from rtabmap_ros.srv._get_plan import GetPlan_Response as Response
