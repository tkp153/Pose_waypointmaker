...
class Metaclass_DetectMoreLoopClosures(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.srv import _detect_more_loop_closures
...
class DetectMoreLoopClosures(metaclass=Metaclass_DetectMoreLoopClosures):
    from rtabmap_ros.srv._detect_more_loop_closures import DetectMoreLoopClosures_Request as Request
    from rtabmap_ros.srv._detect_more_loop_closures import DetectMoreLoopClosures_Response as Response
