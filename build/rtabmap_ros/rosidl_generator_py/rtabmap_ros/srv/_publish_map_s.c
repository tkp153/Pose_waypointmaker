...
bool rtabmap_ros__srv__publish_map__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._publish_map.PublishMap_Request", full_classname_dest, 47) == 0);
  }
  rtabmap_ros__srv__PublishMap_Request * ros_message = _ros_message;
  {  // global_map
...
PyObject * rtabmap_ros__srv__publish_map__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._publish_map");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__publish_map__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._publish_map.PublishMap_Response", full_classname_dest, 48) == 0);
  }
  rtabmap_ros__srv__PublishMap_Response * ros_message = _ros_message;
