...
bool rtabmap_ros__srv__detect_more_loop_closures__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._detect_more_loop_closures.DetectMoreLoopClosures_Request", full_classname_dest, 73) == 0);
  }
  rtabmap_ros__srv__DetectMoreLoopClosures_Request * ros_message = _ros_message;
  {  // cluster_radius_max
...
PyObject * rtabmap_ros__srv__detect_more_loop_closures__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.srv._detect_more_loop_closures");
...
ROSIDL_GENERATOR_C_EXPORT
bool rtabmap_ros__srv__detect_more_loop_closures__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.srv._detect_more_loop_closures.DetectMoreLoopClosures_Response", full_classname_dest, 74) == 0);
  }
  rtabmap_ros__srv__DetectMoreLoopClosures_Response * ros_message = _ros_message;
  {  // detected
