...
class RGBDImages(metaclass=Metaclass_RGBDImages):
    ...
    _fields_and_field_types = {
        ...
        'rgbd_images': 'sequence<rtabmap_ros/RGBDImage>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'RGBDImage')),  # noqa: E501
    )
