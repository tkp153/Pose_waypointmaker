...
bool rtabmap_ros__msg__camera_model__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._camera_model.CameraModel", full_classname_dest, 41) == 0);
  }
  rtabmap_ros__msg__CameraModel * ros_message = _ros_message;
  {  // camera_info
...
{
  /* NOTE(esteve): Call constructor of CameraModel */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._camera_model");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraModel");
