...
bool rtabmap_ros__msg__global_descriptor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._global_descriptor.GlobalDescriptor", full_classname_dest, 51) == 0);
  }
  rtabmap_ros__msg__GlobalDescriptor * ros_message = _ros_message;
  {  // header
  ...
  {  // info
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->info.data;
...
{
  /* NOTE(esteve): Call constructor of GlobalDescriptor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._global_descriptor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GlobalDescriptor");
  ...
  {  // info
    ...
    if (ros_message->info.size > 0) {
      ...
      uint8_t * src = &(ros_message->info.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->info.size * sizeof(uint8_t));
      assert(data != NULL);
