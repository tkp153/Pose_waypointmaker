...
bool rtabmap_ros__msg__path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtabmap_ros.msg._path.Path", full_classname_dest, 26) == 0);
  }
  rtabmap_ros__msg__Path * ros_message = _ros_message;
  {  // header
  ...
  {  // node_ids
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->node_ids.data;
...
PyObject * rtabmap_ros__msg__path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtabmap_ros.msg._path");
  ...
  {  // node_ids
    ...
    if (ros_message->node_ids.size > 0) {
      ...
      int32_t * src = &(ros_message->node_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->node_ids.size * sizeof(int32_t));
      assert(data != NULL);
