...
class Metaclass_CameraModels(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_ros.msg import CameraModel
...
class CameraModels(metaclass=Metaclass_CameraModels):
    ...
    _fields_and_field_types = {
        'models': 'sequence<rtabmap_ros/CameraModel>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_ros', 'msg'], 'CameraModel')),  # noqa: E501
    )
