...
QT_INIT_METAOBJECT const QMetaObject rtabmap_ros::InfoDisplay::staticMetaObject = { {
    &rviz_common::MessageFilterDisplay<rtabmap_ros::msg::Info>::staticMetaObject,
...
void *rtabmap_ros::InfoDisplay::qt_metacast(const char *_clname)
{
    ...
    return rviz_common::MessageFilterDisplay<rtabmap_ros::msg::Info>::qt_metacast(_clname);
}

int rtabmap_ros::InfoDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = rviz_common::MessageFilterDisplay<rtabmap_ros::msg::Info>::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
