...
QT_MOC_LITERAL(9, 160, 38), // "rviz_common::properties::Enum..."
QT_MOC_LITERAL(10, 199, 4), // "prop"
QT_MOC_LITERAL(11, 204, 26), // "setColorTransformerOptions"
QT_MOC_LITERAL(12, 231, 21), // "updateCloudParameters"
QT_MOC_LITERAL(13, 253, 24), // "downloadNamespaceChanged"
QT_MOC_LITERAL(14, 278, 11), // "downloadMap"
QT_MOC_LITERAL(15, 290, 13) // "downloadGraph"
...
QT_INIT_METAOBJECT const QMetaObject rtabmap_ros::MapCloudDisplay::staticMetaObject = { {
    &rviz_common::MessageFilterDisplay<rtabmap_ros::msg::MapData>::staticMetaObject,
...
void *rtabmap_ros::MapCloudDisplay::qt_metacast(const char *_clname)
{
    ...
    return rviz_common::MessageFilterDisplay<rtabmap_ros::msg::MapData>::qt_metacast(_clname);
}

int rtabmap_ros::MapCloudDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = rviz_common::MessageFilterDisplay<rtabmap_ros::msg::MapData>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 12)
