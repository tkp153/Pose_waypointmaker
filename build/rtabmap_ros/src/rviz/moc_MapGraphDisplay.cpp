...
QT_INIT_METAOBJECT const QMetaObject rtabmap_ros::MapGraphDisplay::staticMetaObject = { {
    &rviz_common::MessageFilterDisplay<rtabmap_ros::msg::MapGraph>::staticMetaObject,
...
void *rtabmap_ros::MapGraphDisplay::qt_metacast(const char *_clname)
{
    ...
    return rviz_common::MessageFilterDisplay<rtabmap_ros::msg::MapGraph>::qt_metacast(_clname);
}

int rtabmap_ros::MapGraphDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = rviz_common::MessageFilterDisplay<rtabmap_ros::msg::MapGraph>::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
