...
bool
rtabmap_ros__msg__RGBDImages__are_equal(const rtabmap_ros__msg__RGBDImages * lhs, const rtabmap_ros__msg__RGBDImages * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // rgbd_images
  if (!rtabmap_ros__msg__RGBDImage__Sequence__are_equal(
...
bool
rtabmap_ros__msg__RGBDImages__copy(
  const rtabmap_ros__msg__RGBDImages * input,
  rtabmap_ros__msg__RGBDImages * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // rgbd_images
  if (!rtabmap_ros__msg__RGBDImage__Sequence__copy(
...
rtabmap_ros__msg__RGBDImages__create()
{
  ...
  rtabmap_ros__msg__RGBDImages * msg = (rtabmap_ros__msg__RGBDImages *)allocator.allocate(sizeof(rtabmap_ros__msg__RGBDImages), allocator.state);
  if (!msg) {
    return NULL;
  }
...
rtabmap_ros__msg__RGBDImages__Sequence__init(rtabmap_ros__msg__RGBDImages__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rtabmap_ros__msg__RGBDImages *)allocator.zero_allocate(size, sizeof(rtabmap_ros__msg__RGBDImages), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rtabmap_ros__msg__RGBDImages__Sequence * array = (rtabmap_ros__msg__RGBDImages__Sequence *)allocator.allocate(sizeof(rtabmap_ros__msg__RGBDImages__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
rtabmap_ros__msg__RGBDImages__Sequence__are_equal(const rtabmap_ros__msg__RGBDImages__Sequence * lhs, const rtabmap_ros__msg__RGBDImages__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rtabmap_ros__msg__RGBDImages__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rtabmap_ros__msg__RGBDImages__Sequence__copy(
  const rtabmap_ros__msg__RGBDImages__Sequence * input,
  rtabmap_ros__msg__RGBDImages__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rtabmap_ros__msg__RGBDImages);
    rtabmap_ros__msg__RGBDImages * data =
      (rtabmap_ros__msg__RGBDImages *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rtabmap_ros__msg__RGBDImages__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rtabmap_ros__msg__RGBDImages__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rtabmap_ros__msg__RGBDImages__copy(
