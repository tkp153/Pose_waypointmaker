...
{
  new (message_memory) rtabmap_ros::msg::CameraModels(_init);
}

void CameraModels_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rtabmap_ros::msg::CameraModels *>(message_memory);
  typed_message->~CameraModels();
}

size_t size_function__CameraModels__models(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rtabmap_ros::msg::CameraModel> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rtabmap_ros::msg::CameraModel> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rtabmap_ros::msg::CameraModel> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CameraModels_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rtabmap_ros::msg::CameraModel>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rtabmap_ros::msg::CameraModels, models),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CameraModels_message_members = {
  ...
  1,  // number of fields
  sizeof(rtabmap_ros::msg::CameraModels),
...
get_message_type_support_handle<rtabmap_ros::msg::CameraModels>()
{
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::CameraModels_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, msg, CameraModels)() {
  return &::rtabmap_ros::msg::rosidl_typesupport_introspection_cpp::CameraModels_message_type_support_handle;
}
