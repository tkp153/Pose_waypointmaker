...
static const _LoadDatabase_Request_type_support_symbol_names_t _LoadDatabase_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, LoadDatabase_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, srv, LoadDatabase_Request)),
  }
};
...
{
  return &::rtabmap_ros::srv::rosidl_typesupport_cpp::LoadDatabase_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_ros, srv, LoadDatabase_Request)() {
  return get_message_type_support_handle<rtabmap_ros::srv::LoadDatabase_Request>();
}
...
static const _LoadDatabase_Response_type_support_symbol_names_t _LoadDatabase_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, LoadDatabase_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, srv, LoadDatabase_Response)),
  }
};
...
{
  return &::rtabmap_ros::srv::rosidl_typesupport_cpp::LoadDatabase_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_ros, srv, LoadDatabase_Response)() {
  return get_message_type_support_handle<rtabmap_ros::srv::LoadDatabase_Response>();
}
...
static const _LoadDatabase_type_support_symbol_names_t _LoadDatabase_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, LoadDatabase)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, srv, LoadDatabase)),
  }
};
...
{
  return &::rtabmap_ros::srv::rosidl_typesupport_cpp::LoadDatabase_service_type_support_handle;
}
