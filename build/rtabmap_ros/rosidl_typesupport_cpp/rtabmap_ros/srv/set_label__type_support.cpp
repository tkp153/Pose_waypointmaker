...
static const _SetLabel_Request_type_support_symbol_names_t _SetLabel_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, SetLabel_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, srv, SetLabel_Request)),
  }
};
...
{
  return &::rtabmap_ros::srv::rosidl_typesupport_cpp::SetLabel_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_ros, srv, SetLabel_Request)() {
  return get_message_type_support_handle<rtabmap_ros::srv::SetLabel_Request>();
}
...
static const _SetLabel_Response_type_support_symbol_names_t _SetLabel_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, SetLabel_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, srv, SetLabel_Response)),
  }
};
...
{
  return &::rtabmap_ros::srv::rosidl_typesupport_cpp::SetLabel_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rtabmap_ros, srv, SetLabel_Response)() {
  return get_message_type_support_handle<rtabmap_ros::srv::SetLabel_Response>();
}
...
static const _SetLabel_type_support_symbol_names_t _SetLabel_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rtabmap_ros, srv, SetLabel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rtabmap_ros, srv, SetLabel)),
  }
};
...
{
  return &::rtabmap_ros::srv::rosidl_typesupport_cpp::SetLabel_service_type_support_handle;
}
