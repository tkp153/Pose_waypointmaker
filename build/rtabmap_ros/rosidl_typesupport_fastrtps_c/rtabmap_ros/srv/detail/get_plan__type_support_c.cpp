...
#include "rtabmap_ros/srv/detail/get_plan__rosidl_typesupport_fastrtps_c.h"
...
using _GetPlan_Request__ros_msg_type = rtabmap_ros__srv__GetPlan_Request;
...
size_t get_serialized_size_rtabmap_ros__srv__GetPlan_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPlan_Request__ros_msg_type * ros_message = static_cast<const _GetPlan_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GetPlan_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__srv__GetPlan_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t max_serialized_size_rtabmap_ros__srv__GetPlan_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtabmap_ros__srv__GetPlan_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, GetPlan_Request)() {
...
#include "rtabmap_ros/msg/detail/path__functions.h"  // plan

// forward declare type support functions
size_t get_serialized_size_rtabmap_ros__msg__Path(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_rtabmap_ros__msg__Path(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, msg, Path)();


using _GetPlan_Response__ros_msg_type = rtabmap_ros__srv__GetPlan_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: plan
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rtabmap_ros, msg, Path
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t get_serialized_size_rtabmap_ros__srv__GetPlan_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPlan_Response__ros_msg_type * ros_message = static_cast<const _GetPlan_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_rtabmap_ros__msg__Path(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__srv__GetPlan_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t max_serialized_size_rtabmap_ros__srv__GetPlan_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: plan
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_rtabmap_ros__msg__Path(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_rtabmap_ros__srv__GetPlan_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, GetPlan_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, GetPlan)() {
