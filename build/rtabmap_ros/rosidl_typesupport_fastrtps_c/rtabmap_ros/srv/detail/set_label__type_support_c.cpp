...
#include "rtabmap_ros/srv/detail/set_label__rosidl_typesupport_fastrtps_c.h"
...
using _SetLabel_Request__ros_msg_type = rtabmap_ros__srv__SetLabel_Request;
...
size_t get_serialized_size_rtabmap_ros__srv__SetLabel_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetLabel_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__srv__SetLabel_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t max_serialized_size_rtabmap_ros__srv__SetLabel_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtabmap_ros__srv__SetLabel_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, SetLabel_Request)() {
...
using _SetLabel_Response__ros_msg_type = rtabmap_ros__srv__SetLabel_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t get_serialized_size_rtabmap_ros__srv__SetLabel_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLabel_Response__ros_msg_type * ros_message = static_cast<const _SetLabel_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__srv__SetLabel_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t max_serialized_size_rtabmap_ros__srv__SetLabel_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtabmap_ros__srv__SetLabel_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, SetLabel_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, SetLabel)() {
