...
#include "rtabmap_ros/srv/detail/publish_map__rosidl_typesupport_fastrtps_c.h"
...
using _PublishMap_Request__ros_msg_type = rtabmap_ros__srv__PublishMap_Request;
...
size_t get_serialized_size_rtabmap_ros__srv__PublishMap_Request(
  const void * untyped_ros_message,
...
static uint32_t _PublishMap_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__srv__PublishMap_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t max_serialized_size_rtabmap_ros__srv__PublishMap_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtabmap_ros__srv__PublishMap_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, PublishMap_Request)() {
...
using _PublishMap_Response__ros_msg_type = rtabmap_ros__srv__PublishMap_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t get_serialized_size_rtabmap_ros__srv__PublishMap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PublishMap_Response__ros_msg_type * ros_message = static_cast<const _PublishMap_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__srv__PublishMap_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rtabmap_ros
size_t max_serialized_size_rtabmap_ros__srv__PublishMap_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_rtabmap_ros__srv__PublishMap_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, PublishMap_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rtabmap_ros, srv, PublishMap)() {
