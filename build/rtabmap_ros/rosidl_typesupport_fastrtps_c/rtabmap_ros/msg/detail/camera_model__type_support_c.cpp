...
#include "rtabmap_ros/msg/detail/camera_model__rosidl_typesupport_fastrtps_c.h"
...
using _CameraModel__ros_msg_type = rtabmap_ros__msg__CameraModel;
...
static uint32_t _CameraModel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__msg__CameraModel(
...
{
  return max_serialized_size_rtabmap_ros__msg__CameraModel(
    full_bounded, 0);
}
