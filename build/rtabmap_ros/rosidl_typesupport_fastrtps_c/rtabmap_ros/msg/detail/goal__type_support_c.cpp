...
#include "rtabmap_ros/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
using _Goal__ros_msg_type = rtabmap_ros__msg__Goal;
...
static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__msg__Goal(
...
{
  return max_serialized_size_rtabmap_ros__msg__Goal(
    full_bounded, 0);
}
