...
#include "rtabmap_ros/msg/detail/global_descriptor__rosidl_typesupport_fastrtps_c.h"
...
using _GlobalDescriptor__ros_msg_type = rtabmap_ros__msg__GlobalDescriptor;
...
static uint32_t _GlobalDescriptor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__msg__GlobalDescriptor(
...
{
  return max_serialized_size_rtabmap_ros__msg__GlobalDescriptor(
    full_bounded, 0);
}
