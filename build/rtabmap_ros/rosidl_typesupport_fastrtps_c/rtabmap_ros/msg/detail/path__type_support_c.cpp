...
#include "rtabmap_ros/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
using _Path__ros_msg_type = rtabmap_ros__msg__Path;
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__msg__Path(
...
{
  return max_serialized_size_rtabmap_ros__msg__Path(
    full_bounded, 0);
}
