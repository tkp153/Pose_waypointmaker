...
#include "rtabmap_ros/msg/detail/map_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rtabmap_ros/msg/detail/map_graph__functions.h"  // graph
#include "rtabmap_ros/msg/detail/node_data__functions.h"  // nodes
...
using _MapData__ros_msg_type = rtabmap_ros__msg__MapData;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      rtabmap_ros__msg__NodeData__Sequence__fini(&ros_message->nodes);
    }
...
static uint32_t _MapData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rtabmap_ros__msg__MapData(
...
{
  return max_serialized_size_rtabmap_ros__msg__MapData(
    full_bounded, 0);
}
